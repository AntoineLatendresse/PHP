...
<div class="wrap">
        ...
        <form action="../Controller/controller_login.php" method="post">
            ...
            <div class="col-md-10">
                <input class="text-box single-line" data-val="true" id="UserName" name="UserName" type="text" value="<?php if (isset($_SESSION[ 'username' ])) echo htmlentities(trim($_SESSION[ 'username' ])); ?>"
                    />
            </div>
            </br>
